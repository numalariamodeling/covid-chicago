...
class covidModel:
    ...
    def __init__(self,expandModel='testDelay_AsSymSys',observeLevel='primary', add_interventions='baseline',
                 change_testDelay=None,trigger_channel=None,emodl_name=None,git_dir=git_dir):
        self.model = 'base'
    ...
    def generate_emodl(self):
        ...
        param_string = covidModel.write_params(self) + param_string + covidModel.write_observed_param(self) + covidModel.write_N_population(self)
