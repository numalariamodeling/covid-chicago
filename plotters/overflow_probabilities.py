...
def get_probs(exp_name):    
    ...
    civis_template = pd.read_csv(os.path.join(datapath, 'covid_IDPH', 'Corona virus reports', 'hospital_capacity_thresholds_template', 'capacity_weekday_average_20200825.csv'))
