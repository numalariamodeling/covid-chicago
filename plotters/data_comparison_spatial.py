...
def compare_ems(exp_name, ems=0, source='EMR'):
    ...
    # plt.show()
    ref_df1 = pd.read_csv(os.path.join(datapath, 'covid_IDPH', 'Cleaned Data', '200522_jg_deceased_date_ems.csv'))
    ref_df2 = pd.read_csv(os.path.join(datapath, 'covid_IDPH', 'Cleaned Data', '200522_jg_admission_date_ems.csv'))
    if ems > 0:
