...
For details, click here [here](https://github.com/numalariamodeling/covid-chicago/tree/master/experiment_configs#intervention_parameters)
...
| 8  	| --scenario          	| -s             | DEPENDS    | FALSE  	| Intervention scenario to use. Might differ for locale and other models.                                                                                                                                                                                                                                | 'Any combination of "baseline", "rollback","triggeredrollback", "reopen","bvariant", "vaccine"' (details [here](https://github.com/numalariamodeling/covid-chicago/blob/master/runScenarios.py#L504)       	| "baseline"                  	|
...
- example 5: `python sample_parameters.py -e "..\experiment_configs\snippets\example.emodl" -load "..\snippets\csv_base.csv" -yaml ".\experiment_configs\snippets\samp_params_combos_example.yaml"`
   - See the example yaml file for how to specify the additional parameters.
