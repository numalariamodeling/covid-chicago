...
| 7  	| --scenario          	| -s             | DEPENDS    | FALSE  	| Intervention scenario to use. Might differ for locale and other models.                                                                                                                                                                                                                                | 'Any combination of "baseline", "rollback","triggeredrollback", "reopen","bvariant", "vaccine"' (Separated by underscore)                                                                                                            	| "baseline"                  	|
