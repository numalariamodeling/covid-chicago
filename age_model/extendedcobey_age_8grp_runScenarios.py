...
def define_Ki_contact_matrix(df):
    ...
    df['Ki1_1'] = 2.518895202
    df['Ki1_2'] = 0.648295899
    df['Ki1_3'] = 0.403854826
    df['Ki1_4'] = 0.922508934
    df['Ki1_5'] = 0.504057076
    df['Ki1_6'] = 0.412414524
    df['Ki1_7'] = 0.259550957
    df['Ki1_8'] = 0.05073959
    df['Ki2_1'] = 0.648295899
    df['Ki2_2'] = 5.857925743
    df['Ki2_3'] = 0.887561841
    df['Ki2_4'] = 0.727965387
    df['Ki2_5'] = 1.04261901
    df['Ki2_6'] = 0.684837537
    df['Ki2_7'] = 0.269607763
    df['Ki2_8'] = 0.042566135
    df['Ki3_1'] = 0.403854826
    df['Ki3_2'] = 0.887561841
    df['Ki3_3'] = 2.859730063
    df['Ki3_4'] = 1.235840304
    df['Ki3_5'] = 0.990130401
    df['Ki3_6'] = 0.859039248
    df['Ki3_7'] = 0.228935133
    df['Ki3_8'] = 0.033866765
    df['Ki4_1'] = 0.922508934
    df['Ki4_2'] = 0.727965387
    df['Ki4_3'] = 1.235840304
    df['Ki4_4'] = 2.193732214
    df['Ki4_5'] = 1.367833626
    df['Ki4_6'] = 0.898917596
    df['Ki4_7'] = 0.364703817
    df['Ki4_8'] = 0.045544761
    df['Ki5_1'] = 0.504057076
    df['Ki5_2'] = 1.04261901
    df['Ki5_3'] = 0.990130401
    df['Ki5_4'] = 1.367833626
    df['Ki5_5'] = 1.860524535
    df['Ki5_6'] = 1.034551661
    df['Ki5_7'] = 0.365736948
    df['Ki5_8'] = 0.061597604
    df['Ki6_1'] = 0.412414524
    df['Ki6_2'] = 0.684837537
    df['Ki6_3'] = 0.859039248
    df['Ki6_4'] = 0.898917596
    df['Ki6_5'] = 1.034551661
    df['Ki6_6'] = 1.409059589
    df['Ki6_7'] = 0.372508504
    df['Ki6_8'] = 0.076732159
    df['Ki7_1'] = 0.259550957
    df['Ki7_2'] = 0.269607763
    df['Ki7_3'] = 0.228935133
    df['Ki7_4'] = 0.364703817
    df['Ki7_5'] = 0.365736948
    df['Ki7_6'] = 0.372508504
    df['Ki7_7'] = 0.707152426
    df['Ki7_8'] = 0.146860318
    df['Ki8_1'] = 0.259550957
    df['Ki8_2'] = 0.269607763
    df['Ki8_3'] = 0.228935133
    df['Ki8_4'] = 0.364703817
    df['Ki8_5'] = 0.365736948
    df['Ki8_6'] = 0.372508504
    df['Ki8_7'] = 0.339232089
    df['Ki8_8'] = 0.386823814
    return df
...
def replace_Ki_contact_param(data, df, sample_nr) :
    ...
    data = data.replace('@Ki1_5@', str(df.Ki1_5[sample_nr]))
    data = data.replace('@Ki1_6@', str(df.Ki1_6[sample_nr]))
    data = data.replace('@Ki1_7@', str(df.Ki1_7[sample_nr]))
    data = data.replace('@Ki1_8@', str(df.Ki1_8[sample_nr]))
    ...
    data = data.replace('@Ki2_5@', str(df.Ki2_5[sample_nr]))
    data = data.replace('@Ki2_6@', str(df.Ki2_6[sample_nr]))
    data = data.replace('@Ki2_7@', str(df.Ki2_7[sample_nr]))
    data = data.replace('@Ki2_8@', str(df.Ki2_8[sample_nr]))
    ...
    data = data.replace('@Ki3_5@', str(df.Ki3_5[sample_nr]))
    data = data.replace('@Ki3_6@', str(df.Ki3_6[sample_nr]))
    data = data.replace('@Ki3_7@', str(df.Ki3_7[sample_nr]))
    data = data.replace('@Ki3_8@', str(df.Ki3_8[sample_nr]))
    ...
    data = data.replace('@Ki4_5@', str(df.Ki4_5[sample_nr]))
    data = data.replace('@Ki4_6@', str(df.Ki4_6[sample_nr]))
    data = data.replace('@Ki4_7@', str(df.Ki4_7[sample_nr]))
    data = data.replace('@Ki4_8@', str(df.Ki4_8[sample_nr]))
    data = data.replace('@Ki5_1@', str(df.Ki5_1[sample_nr]))
    data = data.replace('@Ki5_2@', str(df.Ki5_2[sample_nr]))
    data = data.replace('@Ki5_3@', str(df.Ki5_3[sample_nr]))
    data = data.replace('@Ki5_4@', str(df.Ki5_4[sample_nr]))
    data = data.replace('@Ki5_5@', str(df.Ki5_5[sample_nr]))
    data = data.replace('@Ki5_6@', str(df.Ki5_6[sample_nr]))
    data = data.replace('@Ki5_7@', str(df.Ki5_7[sample_nr]))
    data = data.replace('@Ki5_8@', str(df.Ki5_8[sample_nr]))
    data = data.replace('@Ki6_1@', str(df.Ki6_1[sample_nr]))
    data = data.replace('@Ki6_2@', str(df.Ki6_2[sample_nr]))
    data = data.replace('@Ki6_3@', str(df.Ki6_3[sample_nr]))
    data = data.replace('@Ki6_4@', str(df.Ki6_4[sample_nr]))
    data = data.replace('@Ki6_5@', str(df.Ki6_5[sample_nr]))
    data = data.replace('@Ki6_6@', str(df.Ki6_6[sample_nr]))
    data = data.replace('@Ki6_7@', str(df.Ki6_7[sample_nr]))
    data = data.replace('@Ki6_8@', str(df.Ki6_8[sample_nr]))
    data = data.replace('@Ki7_1@', str(df.Ki7_1[sample_nr]))
    data = data.replace('@Ki7_2@', str(df.Ki7_2[sample_nr]))
    data = data.replace('@Ki7_3@', str(df.Ki7_3[sample_nr]))
    data = data.replace('@Ki7_4@', str(df.Ki7_4[sample_nr]))
    data = data.replace('@Ki7_5@', str(df.Ki7_5[sample_nr]))
    data = data.replace('@Ki7_6@', str(df.Ki7_6[sample_nr]))
    data = data.replace('@Ki7_7@', str(df.Ki7_7[sample_nr]))
    data = data.replace('@Ki7_8@', str(df.Ki7_8[sample_nr]))
    data = data.replace('@Ki8_1@', str(df.Ki8_1[sample_nr]))
    data = data.replace('@Ki8_2@', str(df.Ki8_2[sample_nr]))
    data = data.replace('@Ki8_3@', str(df.Ki8_3[sample_nr]))
    data = data.replace('@Ki8_4@', str(df.Ki8_4[sample_nr]))
    data = data.replace('@Ki8_5@', str(df.Ki8_5[sample_nr]))
    data = data.replace('@Ki8_6@', str(df.Ki8_6[sample_nr]))
    data = data.replace('@Ki8_7@', str(df.Ki8_7[sample_nr]))
