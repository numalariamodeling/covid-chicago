...
daily_cases_deaths_21to70 <- subset(tested,!(tested$age_group %in% c("Under 21","71-80","Over 80")) & tested$age_group!="" )
daily_cases_deaths_21to70 <- daily_cases_deaths_21to70[,c("id","race_for_cfr_plot","specimen_collection","deceased_date","test_race_label","death_race_label")]
...
test_dates <- unique(paste(daily_cases_deaths_21to70$specimen_collection))[order(unique(paste(daily_cases_deaths_21to70$specimen_collection)))]
death_dates <- unique(paste(daily_cases_deaths_21to70$deceased_date[daily_cases_deaths_21to70$deceased_date!=""]))[order(unique(paste(daily_cases_deaths_21to70$deceased_date[daily_cases_deaths_21to70$deceased_date!=""])))]
...
{
   for (r in levels(daily_cases_deaths_21to70$race_for_cfr_plot))
   {
      sub <- subset(daily_cases_deaths_21to70,paste(daily_cases_deaths_21to70$race_for_cfr_plot) == r)
...
daily_cases_deaths_21to70_summary <- data.frame(race = rs, date = ds, n_cases = nc, n_deaths = nd)
write.csv(daily_cases_deaths_21to70_summary,paste(pull_date,"Daily Cases and Deaths by Race (test date).csv",sep=" - "))
...
daily_cases_deaths_21to70_summary <- data.frame(race = rs, date = ds, n_cases = nc, n_deaths = nd)
write.csv(daily_cases_deaths_21to70_summary,paste(pull_date,"Daily Cases and Deaths by Race (test or death Date).csv",sep=" - "))
...
daily_cases_deaths_21to70 <- subset(tested,!(tested$age_group %in% c("Under 21","71-80","Over 80")) & tested$age_group!="" )
daily_cases_deaths_21to70 <- daily_cases_deaths_21to70[,c("id","RR","specimen_collection","deceased_date","test_race_label","death_race_label")]
...
for(i in 1:length(dates))
{
   for (r in levels(daily_cases_deaths_21to70$RR))
   {
      sub <- subset(daily_cases_deaths_21to70,paste(daily_cases_deaths_21to70$RR) == r)
...
daily_cases_deaths_21to70_summary <- data.frame(region = rs, date = ds, n_cases = nc, n_deaths = nd)
write.csv(daily_cases_deaths_21to70_summary,paste(pull_date,"Daily Cases and Deaths by Region (test date).csv",sep=" - "))
...
daily_cases_deaths_21to70_summary <- data.frame(region = rs, date = ds, n_cases = nc, n_deaths = nd)
write.csv(daily_cases_deaths_21to70_summary,paste(pull_date,"Daily Cases and Deaths by Region (test or death Date).csv",sep=" - "))
```
