...
```{r}
knitr::kable(pop18_agebins %>% subset(select=c(under5, age5_19, age20_64, above64, Region)) %>% group_by(Region) %>% summarise_at(vars(c(under5, age5_19, age20_64, above64)), funs(sum(., na.rm=TRUE))))
